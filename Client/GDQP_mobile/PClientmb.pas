...
var
  MaSV, Username, Password,inputIDCB:string;
begin
  Username := Edit1.Text;
  Password := Edit3.Text;
  ...
  begin
    ...
    begin
      ...
      Form1 := TForm1.CreateWithMaSV(Self, MaSV);
      Form1.Show;
      Self.Hide;
    end
    else
  ...
  begin
    ...
    begin
      inputIDCB := InputBox('Xác thực giảng viên', 'Nhập IDCB:', '');
      if inputIDCB = '' then
      begin
      ...
      ShowMessage('Đăng nhập giảng viên thành công! IDCB: ' + inputIDCB);
      Form1 := TForm1.CreateWithMaGV(Self, inputIDCB);
      Form1.Show;
      Self.Hide;
    end
    else
